...
_Comandos de Git más utilizados_
...
| `git clone [url-de-remote-repo]` | Crea una copia local de un repositorio remoto |
...
| `git add [nombre-del-archivo.txt]` | Añade un archivo al area de staging para subir cambios |
| `git add -A` | Añade todos los archivos modificados o creados del repositorio al area de staging para subir cambios |
...
| `git rebase [nombre de la rama a adelantar]` | Actualiza la rama actual con los commits de la rama indicada |
